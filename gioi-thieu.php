...
<html>
    <head>
        <title> Tiêu đề trang giới thiệu </title>
        <meta charset="utf-8">
                    ...
                    <div class="col-md-9 bor">
                        ...
                        <section style="padding: 20px;">
                            ...
                            <div class="about-item" style="margin: 20px 0">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img src="/public/images/default-user.png" class="img img-responsive">
                                    </div>
                                    <div class="col-sm-6">
                            ...
                            <div class="about-item" style="margin: 20px 0">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="/public/frontend/images/anh3.png" class="img img-responsive">
                                    </div>
                                </div>
                            </div>
                            <div class="about-item" style="margin: 20px 0">
